...
class AmbulanceRecordDetail extends StatefulWidget {
  ...
  final String rescue_location_name;

  AmbulanceRecordDetail({
    required this.rescue_location_name,
  ...
  @override
  _AmbulanceRecordDetailState createState() => _AmbulanceRecordDetailState();
}

class _AmbulanceRecordDetailState extends State<AmbulanceRecordDetail> {
  ...
  Future<void> fetchUserData() async {
    final DocumentReference ambulanceRef =
        FirebaseFirestore.instance.collection('RescueReport').doc(widget.user_id);
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.0),
                Text('Patient name: ${widget.rescue_location_name}'),
                SizedBox(height: 8.0),
                Text(

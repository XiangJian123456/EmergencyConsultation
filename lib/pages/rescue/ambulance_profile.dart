...
class _AmbulanceProfileState extends State<AmbulanceProfile> {
  ...
  Future<void> _fetchUserData() async {
    try {
      ...
      if (user != null) {
        DocumentSnapshot userData = await FirebaseFirestore.instance.collection('ambulance').doc(user.uid).get();
...
Future<void> _updateProfile() async {
  ...
  try {
    ...
    DocumentSnapshot userDoc = await FirebaseFirestore.instance.collection('ambulance').doc(userId).get();
    ...
    if (userDoc.exists) {
      ...
      await FirebaseFirestore.instance.collection('ambulance').doc(userId).update(userData);
    } else {
      ...
      await FirebaseFirestore.instance.collection('ambulance').doc(userId).set(userData);
    }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => AmbulanceMainPages() ));
                  },
                  child: Text('OK'),
      ...
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () => Navigator.pushReplacement(
            context,
            MaterialPageRoute(builder: (context) => AmbulanceMainPages()), // Navigate to RescueMainPages
          )
        ),

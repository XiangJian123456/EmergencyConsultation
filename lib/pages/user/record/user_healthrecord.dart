...
import 'package:emergencyconsultation/pages/user/record/user_health_detail.dart';
...
HealthRecordScreen({Key? key}) : super(key: key);
  ...
  Widget buildAmbulanceRecordUI(Map<String, dynamic> data, BuildContext context) {
    ...
    ListTile(
       ...
       onTap: () { // Removed BuildContext parameter
        Navigator.push(context, MaterialPageRoute(builder: (context) => (UserHealthDetail(

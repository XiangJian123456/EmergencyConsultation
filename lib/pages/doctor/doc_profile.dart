...
Future<void> _updateProfile() async {
  ...
  try {
    ...
    DocumentSnapshot userDoc = await FirebaseFirestore.instance.collection('doctors').doc(userId).get();
    ...
    if (userDoc.exists) {
      ...
      await FirebaseFirestore.instance.collection('doctors').doc(userId).update(userData);
    } else {
      ...
      await FirebaseFirestore.instance.collection('doctors').doc(userId).set(userData);
    }
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DoctorMainPages() ));
                  },
                  child: Text('OK'),

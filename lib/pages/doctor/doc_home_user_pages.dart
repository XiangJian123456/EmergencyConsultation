...
class DoctorUserHomePage extends StatefulWidget {
  const DoctorUserHomePage({super.key});

  @override
  _DoctorUserHomePageState createState() => _DoctorUserHomePageState();
}

class _DoctorUserHomePageState extends State<DoctorUserHomePage> {
  @override

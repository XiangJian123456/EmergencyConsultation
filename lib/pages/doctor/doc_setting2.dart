...
class DoctorSettingUserPage2 extends StatefulWidget {
  const DoctorSettingUserPage2({super.key});

  @override
  State<DoctorSettingUserPage2> createState() => _DoctorSettingUserPage2State();
}

class _DoctorSettingUserPage2State extends State<DoctorSettingUserPage2> {
